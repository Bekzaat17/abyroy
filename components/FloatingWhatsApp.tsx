...
export default function FloatingWhatsApp({ lang }: { lang: Lang }) {
  ...
  return (
    <a
      ...
      className="hidden md:flex fixed bottom-8 right-8 z-40 w-14 h-14 rounded-full bg-[#25D366] shadow-xl shadow-black/20 items-center justify-center hover:scale-105 active:scale-95 transition-transform"
    >
      <span className="animate-whatsapp-pulse absolute inset-0 rounded-full"></span>
