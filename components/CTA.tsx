      ...
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 md:gap-4">
          <a
            ...
            className="animate-call-pulse inline-flex items-center gap-3 bg-rehab-gold text-white px-6 py-3 md:px-10 md:py-4 rounded-2xl font-bold hover:bg-rehab-gold-dark transition shadow-xl text-base md:text-lg"
          >
            <Phone size={22} />
            {SITE_DATA.phone}
          </a>
          <a
            ...
            className="animate-whatsapp-pulse inline-flex items-center gap-3 bg-white text-rehab-dark px-6 py-3 md:px-10 md:py-4 rounded-2xl font-bold hover:bg-gray-100 transition shadow-xl text-base md:text-lg"
          >
