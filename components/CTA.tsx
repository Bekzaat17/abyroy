...
export default function CTA() {
  return (
    <section className="py-16 md:py-20 bg-rehab-dark">
      <div className="max-w-4xl mx-auto px-4 text-center">
        <h2 className="text-2xl md:text-4xl font-bold text-white mb-4">
          Не откладывайте — сделайте первый шаг сегодня
        </h2>
        <p className="text-gray-400 text-sm md:text-base mb-8 max-w-xl mx-auto">
          Бесплатная и анонимная консультация по лечению наркомании, алкоголизма
          и игромании в Шымкенте. Позвоните или напишите — мы на связи.
        </p>
        <div className="flex flex-wrap items-center justify-center gap-3 md:gap-4">
          <a
            href={`tel:${SITE_DATA.phone.replace(/[^\d+]/g, "")}`}
            className="animate-call-pulse inline-flex items-center gap-3 bg-rehab-gold text-white px-6 py-3 md:px-10 md:py-4 rounded-2xl font-bold hover:bg-rehab-goldDark transition shadow-xl text-base md:text-lg"
          >
            <Phone size={22} />
            {SITE_DATA.phone}
          </a>
          <a
            ...
            className="inline-flex items-center gap-3 bg-white text-rehab-dark px-6 py-3 md:px-10 md:py-4 rounded-2xl font-bold hover:bg-gray-100 transition shadow-xl text-base md:text-lg"
          >
