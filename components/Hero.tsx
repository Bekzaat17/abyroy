...
export default function Hero({ lang }: { lang: Lang }) {
  ...
  return (
    <section className="relative min-h-[640px] h-[85vh] md:h-[90vh] flex flex-col justify-center overflow-hidden bg-[#FFFFFF]">
      {/* Фон */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 w-full h-full grid grid-cols-12 items-center">
        ...
        <div className="col-span-12 md:col-span-7 mt-12 md:mt-0 text-center md:text-left z-20 max-w-[700px]">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-[#333333] leading-tight mb-4 md:mb-5">
          ...
          <div className="grid grid-cols-3 gap-2 md:gap-8 max-w-lg mx-auto md:mx-0 mb-8 md:mb-10">
            <div className="flex flex-col">
              ...
              <span className="text-[10px] md:text-sm text-gray-500 whitespace-nowrap">{h.statYears.label}</span>
            </div>
            <div className="flex flex-col">
              <span className="text-xl md:text-3xl font-bold text-[#333333]">{h.statTrusted.value}</span>
              <span className="text-[10px] md:text-sm text-gray-500 whitespace-nowrap">{h.statTrusted.label}</span>
            </div>
            <div className="flex flex-col">
              <span className="text-xl md:text-3xl font-bold text-[#333333]">{h.statProgram.value}</span>
              <span className="text-[10px] md:text-sm text-gray-500 whitespace-nowrap">{h.statProgram.label}</span>
            </div>
          </div>
