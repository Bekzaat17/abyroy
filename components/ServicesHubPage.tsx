        ...
        <section className="py-16 md:py-24">
          <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <aside className="mt-12 rounded-3xl border border-rehab-gold/20 bg-rehab-gold/5 p-6 sm:p-8">
              ...
              <Link
                href={isRu ? "/ru/answers/" : "/answers/"}
                className="mt-5 inline-flex items-center gap-2 text-sm font-bold text-rehab-gold"
              >
                {isRu ? "Посмотреть ответы на частые ситуации" : "Жиі кездесетін жағдайларға жауаптарды көру"}
